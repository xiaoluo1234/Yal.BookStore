...
using Yal.BookStore.Blazor.WebApp.Tiered.Client;
using Yal.BookStore.Blazor.WebApp.Tiered.Client.Menus;
using Yal.BookStore.Blazor.WebApp.Tiered.Components;
using Yal.BookStore.Blazor.WebApp.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Yal.BookStore.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
